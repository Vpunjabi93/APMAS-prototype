    ...
    <section className="py-16 md:py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {audience.map((item, i) => (
            <div key={i} className="flex items-start p-6 bg-gray-50 rounded-none border border-gray-100 hover:border-brand-blue/30 hover:shadow-md transition-all">
              <div className="mt-1 flex-shrink-0 w-8 h-8 bg-brand-blue/10 text-brand-blue rounded-none flex items-center justify-center mr-4">
        ...
        <div className="max-w-3xl bg-brand-purple-light/50 border border-brand-purple-light rounded-none p-6 relative overflow-hidden">
